...
@Service
public class CustomUserDetailsService implements UserDetailsService { //put cursor on UserDetailsService and press alt+enter button for get all Override methods
