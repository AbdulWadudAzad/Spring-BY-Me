...
public class User {
    ...
    public User(String firstName, String lastName, String userName, String password, @Email @NotEmpty(message = "Enter An Email") String email, boolean enabled, String confirmationToken, Set<Role> roles) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, userName, password, email, enabled, confirmationToken, roles);
    }
